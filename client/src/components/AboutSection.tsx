      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="max-w-3xl mx-auto text-gray-600">
            Experience the premier tech and coding conference in Miami for 2026, powered by Replit. Join industry leaders for five days of cutting-edge technology, innovative workshops, and beachside networking at South Beach's most anticipated coding event.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <FeatureCard 
            ...
            description="Connect with 1000+ developers, founders, and tech leaders at Miami's premier coding conference. Build relationships within the tech community."
          />
          <FeatureCard 
            ...
            title="Miami Tech Event Atmosphere"
            description="Experience South Beach's premier coding event in paradise. Evening beach events, sunrise yoga, and exclusive Miami tech experiences complement the conference program."
          />
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div>
                  ...
                  <ul className="space-y-4 text-gray-300">
                    {[
                      ...
                      "Miami's largest tech hackathon with $50,000 in prizes",
                      "South Beach networking events connecting the tech community",
              ...
              <div className="hidden lg:block">
                <img 
                  ...
                  alt="Vibe Coding Conference 2026 in South Beach Miami - Tech and Coding Event" 
